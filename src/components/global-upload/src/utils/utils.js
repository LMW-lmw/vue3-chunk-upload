...
// export function generateMD52(file, chunkSize = 10 * 1024 * 1024, options = {}) {
...
// export function getAllMd5(totalFile) {
//   return new Promise((resolve, reject) => {
//     const file = totalFile.file
//     const blobSlice =
//       File.prototype.slice ||
//       File.prototype.mozSlice ||
//       File.prototype.webkitSlice
//     const spark = new SparkMD5.ArrayBuffer()
//     const fileReader = new FileReader()
//     const blob = blobSlice.call(file, 0, file.size)
